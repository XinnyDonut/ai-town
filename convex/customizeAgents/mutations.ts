...
// import { mutation } from "../_generated/server";
// import { MutationCtx } from "../_generated/server";  // 加入 MutationCtx

// export const createAgent = mutation({
//   handler: async (ctx, args: { name: string; character: string; identity: string; plan: string }) => {
//     return await ctx.db.insert("agents", {
//       name: args.name,
//       character: args.character,
//       identity: args.identity,
...
// export const selectAgentForWorld = mutation({
//     handler: async (ctx: MutationCtx, args: { agentIds: string[] }) => {
//       return await ctx.db.insert("selectedAgents", {
//         agentIds: args.agentIds,
//         createdAt: Date.now(),
//       });
